...
int rows1 = ReadInt("Введите количество строк второй матрицы: ");
int columns1 = ReadInt("Введите количество столбцов второй матрицы: ");
...
if (array.GetLength(0) != secondArray.GetLength(1)&&array.GetLength(0) != secondArray.GetLength(1))
{
